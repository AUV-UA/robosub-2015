...
class CapturingCameraView {
  ...
  protected CapturingCanvas3D canvas = null;
  
  public CapturingCameraView (int width, int height) {
    this(width, height, false);
  }

  public CapturingCameraView (int width, int height, boolean offscreen) {
    ...
    canvas = new CapturingCanvas3D( gconfig, offscreen );
  ...
  public CapturingCanvas3D getCanvas3D() {
    return this.canvas;
  }
